...
export default interface QuestProps {
     ...
     * @default undefined
     */
    renderIcon?: GraphicItemType | Promise<GraphicItemType> | ((room: Quest, props: OnRenderGraphicItemProps) => GraphicItemType | Promise<GraphicItemType>)
    /**
     ...
     * @default undefined
     */
    renderImage?: GraphicItemType | Promise<GraphicItemType> | ((room: Quest, props: OnRenderGraphicItemProps) => GraphicItemType | Promise<GraphicItemType>)
